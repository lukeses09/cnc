				...
				<form action="payment.php" method="post">
						<div class="container-fluid">
							...
							<div class="col-xs-12">
								...
								<div class="col-xs-5">
									<div class="form-group">
										<input type="text" class="form-control" id="emergencyfee" name="emergencyfee">
									</div>
								</div>
							</div>
							<div class="col-xs-12">
								...
								<div class="col-xs-5">
									<div class="form-group">
										<input type="text" class="form-control" id="hservicefee" name="hservicefee">
									</div>
								</div>
							</div>
							<div class="col-xs-12">
							...
							<div class="col-xs-12">
								...
								<div class="col-xs-5">
									<div class="form-group">
										<input type="text" class="form-control" id="heartworm" name="heartworm">
									</div>
								</div>
							</div>
							<div class="col-xs-12">
							...
							<div class="col-xs-12">
								...
								<div class="col-xs-5">
									<div class="form-group">
										<input type="text" class="form-control" id="boarding" name="boarding"s>
									</div>
								</div>
							</div>
							<div class="col-xs-12">
								...
								<div class="col-xs-5">
									<div class="form-group">
										<input type="text" class="form-control" id="confinement" name="confinement">
									</div>
								</div>
							</div>
							<div class="col-xs-12">
